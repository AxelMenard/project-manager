...
<template>
  ...
  <nav class="nav">
    <ul class="pt-5">
      <li><RouterLink to="/" @click="closeMenuPanel">Home</RouterLink></li>
      <li>
        <RouterLink to="/about" @click="closeMenuPanel">About</RouterLink>
      </li>
      <li>
        <RouterLink to="/portfolio" @click="closeMenuPanel"
          >Portfolio</RouterLink
        >
      </li>
      <li><a href="#" @click="closeMenuPanel">Contact</a></li>
    </ul>
  </nav>
</template>
...
@media screen and (max-width: 991px) {
  ...
  h1 {
    ...
    text-transform: 2px transparent;
    -webkit-text-fill-color: #ffeba7;
    scrollbar-color: #ffeba7;
    color: #ffeba7;
  }
  .nav ul li a {
    font-size: 8vh;
